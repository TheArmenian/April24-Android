...
//    public JSONArray userLocalFavorites;
    ...
    public JSONArray localFavorites; // = new JSONArray();
    ...
    public void save()
    {
        ...
        ed.putString("localFavorites", localFavorites.toString());
...
//        ed.putString("userLocalFavorites", userLocalFavorites.toString());
	...
	public void load()
    {
        ...
        try {
        	...
        	localFavorites = new JSONArray(sPref.getString("localFavorites", "[]"));
...
//			userLocalFavorites = new JSONArray(sPref.getString("userLocalFavorites", "[]"));
    ...
    {
        return "http://april24.com/cropper/thumb.php?w=" + screenWidth + "&h=" + screenWidth + "&zc=1&src=" + url;
    }
